...
export default function GIFGroover() {
    ...
    "use strict";
    var interlacedBufSize, deinterlaceBuf, pixelBufSize, pixelBuf, st, timerID, currentFrame, currentTime, playing,
        loading, complete, cancel, disposalMethod, transparencyGiven, delayTime, transparencyIndex, gifWidth, gifHeight,
        duration, frameTime, playSpeed, nextFrameTime, nextFrame, lastFrame, bgColorCSS, gifSrc, paused, colorRes,
        globalColourCount, bgColourIndex, globalColourTable;
    ...
    function loadGif(filename) { // starts the load
        let [_1, _2, data] = /^data:.+\/(.+);base64,(.*)$/.exec(filename);
        dataLoaded(Buffer.from(data, 'base64'));
    }
