            ...
            return new Proxy({}, {
                get(_, prop) {
                    ...
                    switch (prop) {
                        ...
                        case '$bg_x':
                            return node.background.x;
                        case '$bg_y':
                            return node.background.y;
                        case '$bg_width':
                            return node.background.width;
                        case '$bg_height':
                            return node.background.height;
                        case '$bg_opacity':
                            return node.background.opacity;
                        case '$bg_paused':
                            return node.background.currentElement?.paused || 0;
                        case '$bg_time':
                            return node.background.currentElement?.currentTime || 0;
                        case '$bg_playback_rate':
                            return node.background.currentElement?.playbackRate || 1;
                        default:
