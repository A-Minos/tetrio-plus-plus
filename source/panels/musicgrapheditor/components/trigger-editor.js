    ...
    template: html`
        <div>
            ...
            <div v-if="dropdownMode.mode == 'fx'">
                <b>Effect scope</b><br>
                <input type="radio" v-model="trigger.event" :value="dropdownMode.event" :id="nonce + '-fxAny'"
                       :name="nonce + '-fxScope'">
                <label :for="nonce + '-fxAny'">Player or Enemy (<code>{{dropdownMode.event}}</code>)</label><br>

                <input type="radio" v-model="trigger.event" :value="dropdownMode.event + '-player'"
                       :id="nonce + '-fxPlayer'" :name="nonce + '-fxScope'">
                <label :for="nonce + '-fxPlayer'">Player (<code>{{dropdownMode.event}}-player</code>)</label><br>

                <input type="radio" v-model="trigger.event" :value="dropdownMode.event + '-enemy'"
                       :id="nonce + '-fxEnemy'" :name="nonce + '-fxScope'">
            ...
            <div v-if="dropdownMode.mode == 'sfx'">
                ...
                <input type="radio" v-model="trigger.event" :value="dropdownMode.event + '-global'"
                       :id="nonce + '-sfxGlobal'" :name="nonce + '-sfxScope'">
                <label :for="nonce + '-sfxGlobal'">Global (<code>{{dropdownMode.event}}-global</code>)</label><br>

                <input type="radio" v-model="trigger.event" :value="dropdownMode.event" :id="nonce + '-sfxAny'"
                       :name="nonce + '-sfxScope'">
                <label :for="nonce + '-sfxAny'">Player or Enemy (<code>{{dropdownMode.event}}</code>)</label><br>

                <input type="radio" v-model="trigger.event" :value="dropdownMode.event + '-player'"
                       :id="nonce + '-sfxPlayer'" :name="nonce + '-sfxScope'">
                <label :for="nonce + '-sfxPlayer'">Player (<code>{{dropdownMode.event}}-player</code>)</label><br>

                <input type="radio" v-model="trigger.event" :value="dropdownMode.event + '-enemy'"
                       :id="nonce + '-sfxEnemy'" :name="nonce + '-sfxScope'">
            ...
            <div v-if="showExpressionEditor">
                ...
                >{{ eventValueExtendedModes[trigger.event] || "Predicate" }}
                </expression-editor>
            </div>
